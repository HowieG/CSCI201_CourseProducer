...
<script src="js/SetupForm.js" type="text/javascript"></script>
...
<body>
	<div id="setup-form">
		<h1>Factory Setup</h1>
		<h4>Hello manager, enter your information</h4>
		<form name="setupform" method="GET">
			<table>
				<tr>
					<td>Name</td>
	...
	<table id="factory-container">
		<tr id="factory-container-top">
			...
			<td class="colorable" id="factory-product-table-container">
				...
				<h3 style="text-align: center;" id="manager-name">
					Manager:
					<%=name%></h3>
